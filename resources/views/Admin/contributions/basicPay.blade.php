...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"> Basic Pay </h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
...
@section('bottom-scripts')
    ...
    <script>
        $(document).ready(function () {
            //  add details
            $("#basicPay-form").on('submit', function (event) {
                event.preventDefault();
                $.ajax({
                    url:'{{ route("Admin.normalContribution") }}',
                    data:$("#basicPay-form").serializeArray(),
                    method:'post',
                    success: function (d) {
                        if (d.code == 1){
                            $('.edit').html(`
