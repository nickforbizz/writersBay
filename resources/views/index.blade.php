		   ...
		   <div class="home-content-tablecell">
		   	<div class="row">
		   		<div class="col-twelve">		   			
			  				...
			  				<h2 class="animate-intro">E-CHAMA.</h2>
				  			<h1 class="animate-intro">
							A platform that  <br>
							Takes your Chama to the next level.
				  			</h1>
   		...
   		<div class="col-full">
   			...
   			<div class="about-profile-bg"></div>
				...
				<div class="intro">
	   			...
	   			<p class="lead animate-this"><span>E-Chama</span> is an app that automatees your chama's activities.It offers an easy and interesting platform for chama members to interact with each other,make contributions,get loans and make savings wherever they are without the need to meet.</p>
				</div>   
   ...
   <section id="services">
   	...
   	<div class="row narrow section-intro with-bottom-sep animate-this">
   		<div class="col-full">
   				...
   				<h3>Services</h3>
   			   <h1>What E-Chama Does.</h1>
   			
   			   <p class="lead">It automates your chama's activities and makes your chama transactions easy to manage.It allows you maake your periodic contributions and chama's savings from the comfort of your home or at your vacation.</p>
   		...
   		<div class="services-list block-1-2 block-tab-full group">
	      	...
	      	<div class="bgrid service-item animate-this">	
	            ...
	            <div class="service-content">
	            	<h3 class="h05">Transaparency</h3>

		            <p>Ever been paranoid to join a Merry-Go-Round chama?Fear no more.E-Chama brings transapency into your chama right inside your pocket.You can follow every chama transaction without the need of meeting.
	         		</p>	         		
	         	</div> 	         	 
	            ...
	            <div class="service-content">	
	            	<h3 class="h05">Financial Management</h3>

		            <p>Manage your normal contributions online and get automated account debits when your turn to receive the amount reaches without any delays and/or issues.
	         		</p>	         		
	            </div>	                          
			   ...
			   <div class="bgrid service-item animate-this">
	            ...
	            <div class="service-content">
	            	<h3 class="h05">Chama Investments</h3>
   			...
   			{{--<div id="folio-wrap" class="bricks-wrapper">					--}}
	               ...
	               {{--<div class="item-wrap animate-this" data-src="images/portfolio/gallery/g-shutterbug.jpg" data-sub-html="#01" > 	--}}
	                  {{--<a href="#" class="overlay">--}}
	                  	{{--<img src="{{ asset('assets/Infinity10/images/portfolio/shutterbug.jpg') }}" alt="Skaterboy">--}}
	                     {{--<div class="item-text">--}}
      ...
      <div class="overlay"></div>
   	...
   	<div class="row contact-content">
   		...
   		<div class="col-seven tab-full animate-this">
            ...
            <!-- form -->
            <form name="contactFormef" id="contactFormf" method="post" action="{{ route('suggestions') }}">
               ...
               <div class="form-field">
	              	<textarea name="description" id="contactMessage" placeholder="message" rows="10" cols="50" required=""></textarea>
	            </div> 
